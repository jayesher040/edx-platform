...
def process_cookie_headers(cookie_headers):
    ...
    for cookie_header in cookie_headers:
        for (name, size) in cookie_header["cookie_sizes"].items():
            ...
            processed_cookie["max_full_size"] = max(full_size, processed_cookie.get("max_full_size", full_size))
            processed_cookie["min_full_size"] = min(full_size, processed_cookie.get("min_full_size", full_size))

            processed_cookie["max_size"] = max(size, processed_cookie.get("max_size", size))
            ...
            processed_cookie["last_seen"] = max(
                cookie_header["datetime"], processed_cookie.get("last_seen", cookie_header["datetime"])
            )
            ...
            processed_cookie["max_cookie_count"] = max(
                ...
                processed_cookie.get("max_cookie_count", len(cookie_header["cookie_sizes"]))
            )
            ...
            processed_cookie["max_header_size"] = max(
                ...
                processed_cookie.get("max_header_size", cookie_header["cookie_header_size"])
            )
